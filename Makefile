...
$(libcppdir)/checkarray.o: lib/checkarray.cpp lib/astutils.h lib/checkarray.h lib/token.h
	$(CXX) ${INCLUDE_FOR_LIB} $(CPPFLAGS) $(CXXFLAGS) -c -o $@ $(libcppdir)/checkarray.cpp
